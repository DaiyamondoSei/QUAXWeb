...
(function() {
  ...
  function waitForElements() {
    ...
    console.log('Quannex Chat Widget: Elements found, initializing...');
  ...
  function initializeChatWidget() {
    ...
    if (!bubble || !windowEl || !closeBtn || !newChatBtn || !form || !input || !messages || !loader || !feedback || !feedbackYes || !feedbackNo || !header) {
      console.error('Quannex Chat Widget: Some required elements not found');
    ...
    console.log('Quannex Chat Widget: All elements found, proceeding with initialization');
